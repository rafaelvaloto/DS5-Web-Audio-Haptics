...
export interface TranslationDictionary {
	...
	triggers: {
		pageTitle: string;
		composeAndSave: string;
		gameLabel: string;
		gamePlaceholder: string;
		effectNameLabel: string;
		effectNamePlaceholder: string;
		effectModeLabel: string;
		modeFeedback: string;
		modeBow: string;
		modeGalloping: string;
		modeWeapon: string;
		modeAutoGun: string;
		modeMachine: string;
		handTriggerLabel: string;
		payloadHexLabel: string;
		testTriggerBtn: string;
		saveProfileBtn: string;
		savedProfilesTitle: string;
		clearAllBtn: string;
	};
}
