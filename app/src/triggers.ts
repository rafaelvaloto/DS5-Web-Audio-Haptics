...
(document.getElementById("btn-apply-trigger") as HTMLButtonElement)?.addEventListener("click", (e) => {
	let modeValue = (document.getElementById("effectMode") as HTMLSelectElement).value;
	let payloadValue = (document.getElementById("hexOutput") as HTMLSelectElement).dataset.payload;
