...
class DualSenseSocketBridge {
    ...
    connect(url = this.url) {
        ...
        if (typeof WebSocket === "undefined") {
            (_a = this.statusListener) === null || _a === void 0 ? void 0 : _a.call(this, "error", "WebSocket is not supported by this browser.");
            return;
        }
        (_b = this.statusListener) === null || _b === void 0 ? void 0 : _b.call(this, "connecting");
        ...
        socket.addEventListener("open", () => {
            ...
            if (this.socket !== socket)
                return;
            this.sentCount = 0;
            (_a = this.statusListener) === null || _a === void 0 ? void 0 : _a.call(this, "connected");
            console.info(`[DualSense Socket] Connected to ${this.url}`);
        });
        socket.addEventListener("error", () => {
            var _a;
            if (this.socket === socket)
                (_a = this.statusListener) === null || _a === void 0 ? void 0 : _a.call(this, "error", `Unable to connect to ${this.url}`);
        ...
        socket.addEventListener("close", () => {
            ...
            if (this.socket !== socket)
                return;
            this.socket = null;
            (_a = this.statusListener) === null || _a === void 0 ? void 0 : _a.call(this, "disconnected");
...
export function createAudioHapticsController(options) {
    ...
    const enable = () => __awaiter(this, void 0, void 0, function* () {
        ...
        const nextStream = yield navigator.mediaDevices.getDisplayMedia({
            video: true,
            audio: true,
        });
        ...
        try {
            ...
            let nextProcessor;
            if (nextContext.audioWorklet &&
                typeof nextContext.audioWorklet.addModule === "function") {
                yield nextContext.audioWorklet.addModule("audio-worklet.js");
            ...
            nextStream.getTracks().forEach((track) => track.addEventListener("ended", () => {
                if (enabled)
    ...
    return {
        enable,
        disable,
        toggle: () => __awaiter(this, void 0, void 0, function* () {
            if (enabled) {
                yield disable();
                return false;
            }
...
export class GamepadClientApplication {
    constructor(module, api, platformCleanup, registryCleanup, logFnPtr, deviceIds = new Set(), managesDiscovery = true) {
        this.previousInput = new Map();
        this.dsExtensionBridge = new DualSenseSocketBridge();
        this.discoveryTimer = null;
        this.inputTimer = null;
        this.isRunning = false;
        this.inputStateListener = null;
    ...
    static fromNativeRuntime(module, api, deviceIds) {
        return new GamepadClientApplication(module, api, { dispose: () => __awaiter(this, void 0, void 0, function* () { }) }, { dispose: () => { } }, null, deviceIds, false);
    }
    static create() {
        return __awaiter(this, arguments, void 0, function* (typeId = 0, requestAccess = true) {
    ...
    run() {
        ...
        const inputHandle = setInterval(() => {
            ...
            for (const deviceId of ids) {
                ...
                (_c = this.inputStateListener) === null || _c === void 0 ? void 0 : _c.call(this, deviceId, state);
            }
        }, FRAME_MS);
    ...
    enableAudioHaptics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ctx.audioWorklet && typeof ctx.audioWorklet.addModule === "function") {
                yield ctx.audioWorklet.addModule("audio-worklet.js");
...
function loadGamepadCoreHostFactory() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        const globalFactory = globalThis
            .InitGamepadCoreHost;
