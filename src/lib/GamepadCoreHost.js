...
function findWasmBinary() {
  return locateFile('GamepadCoreHost.wasm');
}
...
var _GCH_GetConnectionType = Module['_GCH_GetConnectionType'] = makeInvalidEarlyAccess('_GCH_GetConnectionType');
var _GCH_BatteryLevelDevice = Module['_GCH_BatteryLevelDevice'] = makeInvalidEarlyAccess('_GCH_BatteryLevelDevice');
var _GCH_Lightbar = Module['_GCH_Lightbar'] = makeInvalidEarlyAccess('_GCH_Lightbar');
var _GCH_LightbarFlash = Module['_GCH_LightbarFlash'] = makeInvalidEarlyAccess('_GCH_LightbarFlash');
var _GCH_PlayerLed = Module['_GCH_PlayerLed'] = makeInvalidEarlyAccess('_GCH_PlayerLed');
var _GCH_ResetLights = Module['_GCH_ResetLights'] = makeInvalidEarlyAccess('_GCH_ResetLights');
var _GCH_DualSenseSettings = Module['_GCH_DualSenseSettings'] = makeInvalidEarlyAccess('_GCH_DualSenseSettings');
var _GCH_ResetGyroOrientation = Module['_GCH_ResetGyroOrientation'] = makeInvalidEarlyAccess('_GCH_ResetGyroOrientation');
var _GCH_EnableGyroscopeValues = Module['_GCH_EnableGyroscopeValues'] = makeInvalidEarlyAccess('_GCH_EnableGyroscopeValues');
var _GCH_EnableTouch = Module['_GCH_EnableTouch'] = makeInvalidEarlyAccess('_GCH_EnableTouch');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['GCH_GetConnectionType'] != 'undefined', 'missing Wasm export: GCH_GetConnectionType');
  assert(typeof wasmExports['GCH_BatteryLevelDevice'] != 'undefined', 'missing Wasm export: GCH_BatteryLevelDevice');
  assert(typeof wasmExports['GCH_Lightbar'] != 'undefined', 'missing Wasm export: GCH_Lightbar');
  assert(typeof wasmExports['GCH_LightbarFlash'] != 'undefined', 'missing Wasm export: GCH_LightbarFlash');
  assert(typeof wasmExports['GCH_PlayerLed'] != 'undefined', 'missing Wasm export: GCH_PlayerLed');
  assert(typeof wasmExports['GCH_ResetLights'] != 'undefined', 'missing Wasm export: GCH_ResetLights');
  assert(typeof wasmExports['GCH_DualSenseSettings'] != 'undefined', 'missing Wasm export: GCH_DualSenseSettings');
  assert(typeof wasmExports['GCH_ResetGyroOrientation'] != 'undefined', 'missing Wasm export: GCH_ResetGyroOrientation');
  assert(typeof wasmExports['GCH_EnableGyroscopeValues'] != 'undefined', 'missing Wasm export: GCH_EnableGyroscopeValues');
  assert(typeof wasmExports['GCH_EnableTouch'] != 'undefined', 'missing Wasm export: GCH_EnableTouch');
  ...
  _GCH_GetConnectionType = Module['_GCH_GetConnectionType'] = createExportWrapper('GCH_GetConnectionType', wasmExports['GCH_GetConnectionType'], 1);
  _GCH_BatteryLevelDevice = Module['_GCH_BatteryLevelDevice'] = createExportWrapper('GCH_BatteryLevelDevice', wasmExports['GCH_BatteryLevelDevice'], 1);
  _GCH_Lightbar = Module['_GCH_Lightbar'] = createExportWrapper('GCH_Lightbar', wasmExports['GCH_Lightbar'], 4);
  _GCH_LightbarFlash = Module['_GCH_LightbarFlash'] = createExportWrapper('GCH_LightbarFlash', wasmExports['GCH_LightbarFlash'], 6);
  _GCH_PlayerLed = Module['_GCH_PlayerLed'] = createExportWrapper('GCH_PlayerLed', wasmExports['GCH_PlayerLed'], 3);
  _GCH_ResetLights = Module['_GCH_ResetLights'] = createExportWrapper('GCH_ResetLights', wasmExports['GCH_ResetLights'], 1);
  _GCH_DualSenseSettings = Module['_GCH_DualSenseSettings'] = createExportWrapper('GCH_DualSenseSettings', wasmExports['GCH_DualSenseSettings'], 9);
  _GCH_ResetGyroOrientation = Module['_GCH_ResetGyroOrientation'] = createExportWrapper('GCH_ResetGyroOrientation', wasmExports['GCH_ResetGyroOrientation'], 1);
  _GCH_EnableGyroscopeValues = Module['_GCH_EnableGyroscopeValues'] = createExportWrapper('GCH_EnableGyroscopeValues', wasmExports['GCH_EnableGyroscopeValues'], 2);
  _GCH_EnableTouch = Module['_GCH_EnableTouch'] = createExportWrapper('GCH_EnableTouch', wasmExports['GCH_EnableTouch'], 2);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = InitGamepadCoreHost;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = InitGamepadCoreHost;
} else if (typeof define === 'function' && define['amd'])
  define([], () => InitGamepadCoreHost);
